  ...
  try {
    ...
    await sendEmail(
      ...
      `You are receiving this email because you have requested to reset your password.
       Please click the following link to reset your password: http://localhost:5173/reset-password/${userDetail._id}/${token}
       If you did not request this, please ignore this email.`,
      `<h3>You are receiving this email because you have requested to reset your password.</h3><br/>
       Please click the following link to reset your password: <b>http://localhost:5173/reset-password/${userDetail._id}/${token}</b>
       If you did not request this, please ignore this email.`,
    );
